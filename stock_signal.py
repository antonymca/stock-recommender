...
# Optional third-party dependencies. They are required for fetching
# real market data but the core logic can be imported without them,
# allowing unit tests to run in lightweight environments.
